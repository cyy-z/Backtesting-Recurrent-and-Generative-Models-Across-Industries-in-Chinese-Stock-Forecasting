...
def wgan_gru(runs,train_loader,test_loader,stock_name='sh000300', industry_name='default',EPOCHS = 300):

    HIDDEN_SIZE = 64
    long_threshold = 0.001
    short_threshold = -0.001
    result_dir = f'./result/wgan-gru/{industry_name}/{stock_name}'
...
def run_wgan_gru_on_all_stocks():
    root_dir = './assets/data_own_f'
    result_dir = './result/wgan-gru'
    os.makedirs(result_dir, exist_ok=True)
